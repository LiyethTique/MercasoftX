...
app.use("/entrada", verifyToken, entradaRoutes);
...
Unidad.hasMany(Entrada, {  foreignKey: "Id_Unidad", as: "entradas" })
Entrada.belongsTo(Unidad, { foreignKey: "Id_Unidad", as: "unidad" })

Producto.hasMany(Entrada, { foreignKey: "Id_Producto", as: "entradas" })
Entrada.belongsTo(Producto, { foreignKey: "Id_Producto", as: "producto"} )
...
export {Area, Unidad, Venta, Pedido, Cliente, Carrito, Producto, Traslado, Responsable, UserModel };