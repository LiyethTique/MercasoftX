...
const URI = process.env.SERVER_BACK + '/cliente/' // Ajusta la URI
...
const CrudCliente = () => {
    ...
    return (
        <>
            ...
            <hr />
            <FormCliente buttonForm={buttonForm} entity={entity} URI={URI} updateTextButton={updateTextButton} />
            <hr />
            <FormQueryCliente URI={URI} getEntity={getEntity} deleteEntity={deleteEntity} buttonForm={buttonForm} />
        </>
    )
}
