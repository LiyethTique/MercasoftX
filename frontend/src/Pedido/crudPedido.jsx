...
import FormPedido from './formPedido'; // Adaptamos el nombre
import Sidebar from '../Sidebar/Sidebar';
import Swal from 'sweetalert2';
import WriteTable from '../Tabla/Data-Table';
import ModalForm from '../Model/Model';

const URI = (process.env.REACT_APP_SERVER_BACK || 'http://localhost:3001') + '/pedido/'; // Ruta de pedidos
...
const CrudPedido = () => {
  ...
  const titles = ['ID Pedido', 'Fecha Pedido', 'Nombre del Cliente', 'Estado Pedido', 'Valor Pedido', 'Acciones'];
  const data = pedidoList.map(pedido => [
    pedido.Id_Pedido,
    pedido.Fec_Pedido,
    pedido.cliente ? pedido.cliente.Nom_Cliente : 'Sin pedido',
    pedido.Est_Pedido,
    pedido.Val_Pedido,
