...
const WriteTable = ({ titles, data, fileName }) => {
    ...
    // useEffect(() => {
    //     console.log('Gestionar Responsable:', fileName);
    // }, [fileName]);
        ...
        <div>
            <div className="d-flex justify-content-between mb-3 align-items-center">
                <div className="d-flex align-items-center">
                    ...
                    >
                        <img src="/pdf.png" alt="Export to PDF" style={{ width: '50px', height: 'auto' }} />
                    </button>
                    <button
                        className="action-button me-2"
                        ...
                        style={{ background: 'none', border: 'none', padding: 0 }}
                    >
                        <img src="/excel.png" alt="Export to Excel" style={{ width: '50px', height: 'auto' }} />
                    </button>
                    <button
                        className="action-button me-2"
                        onClick={exportToSQL}
                        ...
                        style={{ background: 'none', border: 'none', padding: 0 }}
                    >
                        <img src="/sql.png" alt="Export to SQL" style={{ width: '50px', height: 'auto' }} />
                    </button>
                </div>
                <input
                    type="text"
