...
const CatalogPage = () => {
  ...
  const handleAddToCart = (product) => {
    ...
    if (existingProduct) {
      // Verifica si agregar el producto excede la existencia
      if (existingProduct.Can_Producto >= product.Exi_Producto) {
        Swal.fire('¡Sin suficiente Existencia!', 'No puedes agregar más unidades este producto.', 'error');
        return; // Sale de la función si se excede el stock
      }
