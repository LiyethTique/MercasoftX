...
const FormQueryResponsables = ({ URI, getresponsable, deleteresponsable, buttonForm }) => {
                    ...
                    <tbody>
                        {responsables.map((responsable) => (
                            <tr key={responsable.id}>
                                ...
                                <td>
                                    <button onClick={() => getresponsable(responsable.id)}>Editar</button>
                                    <button onClick={() => deleteresponsable(responsable.id)}>Borrar</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
