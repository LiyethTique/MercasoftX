...
export const createUser = async (req, res) => {
    ...
    try {
        ...
        let userOk = await usuarioModel.findOne({ where: {email: email}})
...
export const loginUser = async (req, res) => {
    ...
    try {
        const userOk = await usuarioModel.findOne({ where: {email: email}})
...
export const getResetPassword = async(req, res) => {
    ...
    const user = usuarioModel.findOne({where:{email: email}})
...
export const setNewPassword = async (req, res) => {
    ...
    try {
        ...
        const user = await usuarioModel.findByPk(decodificado.id)
