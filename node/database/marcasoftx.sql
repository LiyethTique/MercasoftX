...
INSERT INTO `carrito` VALUES (1,5,'2024-08-13','2024-08-13'),(2,10,'2024-08-13','2024-08-13');
...
CREATE TABLE `categoria` (
  ...
  `Nom_Categoria` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `createdAT` date NOT NULL,
  `updatedAT` date NOT NULL,
...
INSERT INTO `categoria` VALUES (1,'Lacteos','2024-08-13','2024-08-13'),(2,'Carnicos','2024-08-13','2024-08-13');
...
CREATE TABLE `cliente` (
  ...
  `Nom_Cliente` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Cor_Cliente` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Tel_Cliente` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `cliente` VALUES (1,'Fabian Moreno','fmoreno@example.com','5551234567',1,'2024-08-13','2024-08-13'),(2,'Maria Montealegre','mmontealegre@example.com','5551234568',2,'2024-08-13','2024-08-13');
...
CREATE TABLE `pedido` (
  ...
  `Est_Pedido` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `producto` (
  ...
  `Car_Producto` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Pre_Promedio` decimal(10,2) DEFAULT NULL,
  `Exi_Producto` int DEFAULT NULL,
  `Ima_Producto` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Fec_Vencimiento` date DEFAULT NULL,
  `Id_Categoria` int DEFAULT NULL,
  `Pre_Anterior` decimal(10,2) DEFAULT NULL,
  `Uni_DeMedida` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `responsable` (
  ...
  `Nom_Responsable` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Cor_Responsable` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Tel_Responsable` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Tip_Responsable` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Tip_Genero` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `createdAT` date NOT NULL,
  `updatedAT` date NOT NULL,
...
INSERT INTO `responsable` VALUES (1,'Juan Perez','jperez@example.com','5551234567','Administrador','Masculino','2024-08-13','2024-08-13'),(2,'Camila Savogal','csavogal@example.com','5551234566','Pasante','Femenino','2024-08-13','2024-08-13');
...
CREATE TABLE `traslado` (
  ...
  `Des_Traslado` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Id_Producto` int DEFAULT NULL,
  `Can_Producto` int DEFAULT NULL,
...
CREATE TABLE `unidad` (
  ...
  `Nom_Unidad` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `createdAT` date NOT NULL,
  `updatedAT` date NOT NULL,
...
-- Dump completed on 2024-08-13 21:21:16
